      ...
      <div className="container-fluid">
        <div className="container privacy_container">
          ...
          <section className="accept_the_term_section">
            <h6>Last updated on 01-07-2024 12:35:20</h6>
            <p className="heading_with_line_one">
            These Terms and Conditions, along with privacy policy or other terms (“Terms”) constitute a binding
            agreement by and between CHANNING AND BARRETT INDUSTRIES PRIVATE LIMITED, (
          ...
          <section className="accept_the_term_section">
            <h2 className="heading_with_line_two">The use of this website or availing of our Services is subject to the following terms of use:</h2>
            <ul>
              <li>
