...
function Achievements() {
  ...
  return (
    <section className="Achievements_section d-flex flex-column align-items-evenly   py-2 my-5 my-md-3 mx-2 mx-md-5 bg-white shadow-sm rounded-4 ">

<div className="Achievements_users  d-flex flex-md-row justify-content-evenly gap-4  ">
{user_data.map((item, index) => (
    <div key={index} className=" single-card d-flex flex-md-row  align-items-center gap-2" >
        <img src={item.image} alt="image" width={55}height={55}  className="rounded-pill"/>
        <h5>{item.h1}</h5>
    </div>
))}
</div>
        <hr className="hr" />
    <div className="Achievements  d-flex flex-md-row justify-content-evenly gap-4 ">
    ...
    <div className="Achievements   d-flex flex-md-row justify-content-evenly gap-5 ">
