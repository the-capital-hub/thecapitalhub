...
function ContentLanguageSettings() {
  ...
  return (
    ...
    <div className="border-top px-3 py-3 d-flex flex-column gap-3 ">
      ...
      <span className="fs-6 text-secondary">
      We'll auto-translate content or show options to translate content such as posts and comments to this language and use this information to improve your overall Capital hub experience.
      </span>
      ...
      <span className="fs-6 text-secondary">
      Which languages do you not want content on Capital hub translated from?
      </span>
      <span className="fs-6 text-secondary">
      We won't auto-translate content or show options to translate content in these languages and we’ll use this information to improve your overall Capital hub experience.
      </span>
      <div>
